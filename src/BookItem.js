        ...
        <Card className ="text-white border-dark bg-dark d-flex flex-column" style={{width :"15rem", margin: "5px"}}>
            ...
            <div className="card-body">
                ...
                <div class="card-footer mt-6">
                    <div>
                    <Button type="button" style={{width: "80%"}} className="btn btn-primary position-absolute bottom-0 start-50 translate-middle-x mb-2" onClick={downloadbook}>Download Book</Button>
